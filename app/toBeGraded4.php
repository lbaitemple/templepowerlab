...
<?php // here comes your delete query: use $_POST['deleteItem'] as your id
	...
	$result = mysqli_query($con, "select * FROM exp4 WHERE id='$a'");
...
----Experiment4 Needs to be Graded </h3>
<div class="col-lg-4 " >
...
$results = json_decode($var, true);
if ($results[3]['qarray'][4] == null) {echo "No Answer Yet!";
} else
	echo $results[3]['qarray'][4];
