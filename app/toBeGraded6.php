...
<?php // here comes your delete query: use $_POST['deleteItem'] as your id
	...
	$result = mysqli_query($con, "select * FROM exp6 WHERE id='$a'");
...
----Experiment6 Needs to be Graded </h3>
<div class="col-lg-4 " >
...
$results = json_decode($var, true);
if ($results[2]['qarray'][0] == null) {echo "No Answer Yet!";
} else
	echo $results[2]['qarray'][0];
...
$results = json_decode($var, true);
if ($results[2]['qarray'][1] == null) {echo "No Answer Yet!";
} else
	echo $results[2]['qarray'][1];
...
$results = json_decode($var, true);
if ($results[2]['qarray'][2] == null) {echo "No Answer Yet!";
} else
	echo $results[2]['qarray'][2];
...
$results = json_decode($var, true);
if ($results[2]['qarray'][3] == null) {echo "No Answer Yet!";
} else
	echo $results[2]['qarray'][3];
...
$results = json_decode($var, true);
if ($results[2]['qarray'][4] == null) {echo "No Answer Yet!";
} else
	echo $results[2]['qarray'][4];
...
<li>
				Did the direction of rotation of the motor reverse in Step 6 of the experiment? Explain. Hint: Use the basic motor principle to find the direction of rotation.		
...
$results = json_decode($var, true);
if ($results[2]['qarray'][5] == null) {echo "No Answer Yet!";
} else
	echo $results[2]['qarray'][5];
...
<li>
			The the direction of rotation of the motor reverse in Step 7? Explain. 	
...
$results = json_decode($var, true);
if ($results[2]['qarray'][6] == null) {echo "No Answer Yet!";
} else
	echo $results[2]['qarray'][6];
...
data :<?php // here comes your delete query: use $_POST['deleteItem'] as your id
	...
	echo "[";
	for ($i = 0; $i < count($results[0]['carray']); $i++) {
		if ($results[0]['carray'][$i] == null)
			break;
		else {
			echo "[";
			echo $i/10;
...
data :<?php // here comes your delete query: use $_POST['deleteItem'] as your id
	...
	echo "[";
	for ($i = 0; $i < count($results[1]['speed']); $i++) {
		if ($results[1]['speed'][$i] == null)
			break;
		else {
			echo "[";
			echo $i/10;
			echo ",";
			echo $results[1]['speed'][$i];
			echo "],";
		}
	}//echo "<script type='text/javascript'>alert('111');</script>";
