...
<?php // here comes your delete query: use $_POST['deleteItem'] as your id
	...
	$result = mysqli_query($con, "select * FROM exp5_3 WHERE id='$a'");
...
----Experiment5_3 Needs to be Graded </h3>
<div class="col-lg-4 " >
...
<?php // here comes your delete query: use $_POST['deleteItem'] as your id
	...
	for ($i = 0; $i < count($results[0]['varray']); $i++) {
...
echo "data : ";
	//varray1
	echo "[";
	for ($i = 0; $i <count($results[1]['varray1']); $i++) {
		if ($results[1]['varray1'][$i] == null)
			break;
		else {
			echo "[";
			echo 0.5 * $i;
