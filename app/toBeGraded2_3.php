...
<?php // here comes your delete query: use $_POST['deleteItem'] as your id
	...
	$result = mysqli_query($con, "select * FROM exp2_3 WHERE id='$a'");
...
----Experiment2_3 Needs to be Graded </h3>
<div class="col-lg-4 " >
...
<a type="submit" name="Submit" href="score2_3.php?deleteItem='.$row['login'].'">Submit Score</a>
