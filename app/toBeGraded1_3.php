...
<?php // here comes your delete query: use $_POST['deleteItem'] as your id
	...
	$result = mysqli_query($con, "select * FROM exp1_3 WHERE id='$a'");
...
----Experiment1_3 Needs to be Graded </h3>
<div class="col-lg-4 " >
...
<tr>
<th>Speed (rpm)</th>
<th>Voltage at 0.5 A</th>
<th>Voltage at 0.8 A</th>
<th>Voltage at 1 A</th>
