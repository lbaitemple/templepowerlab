...
<html>
	...
	<head>
		...
		<link href="experiment3/css/styles.css" rel="stylesheet" type="text/css">
<link href="css/plugins/tutor/styles.css" rel="stylesheet" />
		<script type="text/javascript">
			function viewTable() {
				...
				var str_json = JSON.stringify(experiment3);
				request = new XMLHttpRequest();
				if (confirm("Do you want to save your data?")) {
					request.open("POST", "JSON_Handler3.php", true);
		...
		<div id="wrapper">
			...
			<div id="page-wrapper">
				<div class="row">
					<div class="col-lg-12">
						<br>
						<h1 class="page-header">Experiment 3</h1>
						<h3>Loading of a Shunt Generator</h3>
					</div>
					<!-- /.col-lg-12 -->
				</div>
				<div class="row">
					<div class="col-lg-12">
						<div class="panel panel-success">
							...
							<div class="panel-body">
								...
								<ul>
									<li>
										Review concept for Experiment 3 before doing the experiment. Follow this <a href="./captivate/callees/experiment3/">link</a>to review the material.
									</li>
							...
							<ul class="grid cs-style-3">
								...
								<figure>
									<img width="600px" src="images/experiment1/circuit_exp3.jpg">
									<figcaption>
										<h3>Circuit Schematic for Experiment </h3>
									</figcaption>
								</figure>
				...
				<div class="row">
					<div class="col-lg-12">
						<div class="panel panel-success">
							<div class="panel-heading">
								Activity 1: Loading of Shunt Generator
							</div>
							<!-- /.panel-heading -->
								...
								<div class="row">
									<div class="col-lg-12">
										...
										<div class="col-lg-7" text-right>
											<ul width="100%" class="nav nav-tabs nav-stacked navbar-right" id="act3">
												<iframe src='experiment3/generator.php' id="info" class="iframe" name='info' width="100%" height="700 px" seamless="seamless" align="left"></iframe>
											</ul>
										</div>
										<!-- /.panel-body -->
										<div class="col-lg-5">
											<div class="row">
												...
												<div class="panel panel-success">
													<div class="panel-heading">
														Follow the steps below to start and load the generator.
													</div>
													<div class="panel-body">
														<ul>
															<li>
														...
														<img width="100%" src="images/experiment1/circuit_exp3.jpg">
									...
									<div class="row">
										...
										<div class="col-lg-8">
											<div class="panel panel-success">
												<div class="panel-heading">
													Review the above plots and answer the following questions.
												</div>
												...
												<ul>
													...
													<li>
														Plot the calculated terminal voltage and the actual terminal voltage as a function of the load current.  Are the two voltage characteristics the same?  If not, discuss why not.  Also discuss the overall load voltage profile.
													</li>
 											...
 											<h4>Question 2:</h4>
												...
												<ul>
													...
													<li>
														Were there any visible sparks at the brushes?  Did the sparks increase or decrease with load?   Discuss any possible reasons for these sparks.
													</li>
 ...
 <h4>Question 4:</h4>
												...
												<ul>
													...
													<li>
														For each load current, compute the voltage regulation. Discuss your result.
													</li>
...
<!-- tutor ends here-->
		...
		<script src="js/plugins/tutor/tutor_exp3.js"></script>
		<!--tutor js end-->
					...
					<script type="text/javascript" src="experiment3/js/plugins/numeric-1.2.6.min.js"></script>
					<script>
