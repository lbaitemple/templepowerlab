...
<?php // here comes your delete query: use $_POST['deleteItem'] as your id
	...
	$result = mysqli_query($con, "select * FROM exp1_2 WHERE id='$a'");
...
----Experiment1_2 Needs to be Graded </h3>
<div class="col-lg-4 " >
...
<label>Score:</label>
<input name="score" type="text" cid="score" placeholder="Score">/30
...
<?php // here comes your delete query: use $_POST['deleteItem'] as your id
	...
	for ($i = 0; $i <= 12; $i++) {
		...
		echo "</p>";
		echo "</td><td><p style='background-color:#FFFF00'>";
		echo $results[0]['varray1'][$i];
		echo "</p>";
		echo "</td><td><p style='background-color:#FFFF00'>";
		echo $results[0]['varray2'][$i];
		echo "</p></td></tr>	";
	}//echo "<script type='text/javascript'>alert('111');</script>";
	mysqli_close($con);
?>
