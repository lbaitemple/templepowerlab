            ...
            <div class="col-md-4 col-md-offset-4">
                <div class="login-panel panel panel-default">
                    ...
                    <div class="panel-body">
                        <form role="form" id="loginForm" name="loginForm" method="post" action="login-exec.php">
                            <fieldset>
                                ...
                                <div class='col-lg-6'>	
                                 ...
                                 <div class='col-lg-6'>
                                 <a href="register-form.php" class="btn btn-lg btn-warning btn-block">Signup</a>
                                </div>
                                </div>
                                OR<p>
                                <div class='col-lg-12' >
                                	<div class='col-lg-12'>
                                <a href="login-exec-1.php" class="btn btn-lg btn-success btn-block">Login as Guest</a>
                     </div></div>
                                      </fieldset>
                        </form>
                    </div>
