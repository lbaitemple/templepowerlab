...
<?php // here comes your delete query: use $_POST['deleteItem'] as your id
	...
	$result = mysqli_query($con, "select * FROM exp8 WHERE id='$a'");
...
----Experiment8 Needs to be Graded </h3>
<div class="col-lg-4 " >
...
<a type="submit" name="Submit" href="score8.php?deleteItem='.$row['login'].'">Submit Score</a>
...
echo "data : ";
	//varray1
	echo "[";
	for ($i = 0; $i <count($results[2]['cspeed']); $i++) {
		if ($results[2]['cspeed'][$i] == null)
			break;
		else {
			echo "[";
			echo 50*$i;
