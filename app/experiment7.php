...
<html>
	...
	<head>
		...
		<link href="experiment7/css/styles.css" rel="stylesheet" type="text/css">

		<link rel="stylesheet" type="text/css" href="experiment7/css/jquery.fancybox.css" media="screen" />
<link href="css/plugins/tutor/styles.css" rel="stylesheet" />
		...
		<div id="wrapper">
			...
			<div id="page-wrapper">
				<div class="row">
					<div class="col-lg-12">
						<br>
						<h1 class="page-header">Experiment 7</h1>
						<h3>Speed Control of Shunt Motor</h3>
					</div>
					<!-- /.col-lg-12 -->
				</div>
				<div class="row">
					<div class="col-lg-12">
						<div class="panel panel-primary">
							...
							<div class="panel-body">
								...
								<ul>
									<li>
										If you didn't finish the Knowledge Concept for Experiment 7, please go to this <a href="./captivate/callees/EXP7/">link</a> and review the concepts.
									</li>
								...
								<ol>
									<li>
										To study various methods of speed control of a shunt motor.
									</li>

									<li>
										To understand the effects of armature reaction on motor speed.
									</li>
									<li>
										To understand relative advantages of motor speed control methods.
									</li>
								</ol>
			<h4>Machine Specification</h4>
							...
							<ul class="grid cs-style-3">
								...
								<figure>
									<img width="600px" src="images/experiment1/circuit_exp7.jpg">
									<figcaption>
										<h3>Circuit Schematic for Experiment 7</h3>
									</figcaption>
								</figure>
							...
							<div class="row">
								<div class="col-lg-12">
									<div class="col-lg-7" text-right>
										<ul width="100%" class="nav nav-tabs nav-stacked navbar-right" id="act7_1">
											<iframe src='experiment7/generator.php' id="info" class="iframe" name='info' width="100%" height="700 px" seamless="seamless" align="left"></iframe>
										</ul>
									</div>
									<div class="col-lg-5">
										<div class="row">
											...
											<div class="col-lg-6">
												...
												<div class="panel panel-default" >
													...
													<ul>
														...
														<li>
															When plotting the motor speed as a function of field current.  You should see an inverse relation between the speed and the field current.  Verify your observation by analyzing the circuit model of the motor.
														</li>
 ...
 <h4>Question 2:</h4>
													...
													<ul>
														...
														<li>
															Plot the calculated motor speed versus field current on the same figure as above.  Is the experimental speed same as the computed speed?  Comment on any differences using the concept of armature reaction.
														</li>
 ...
 <h4>Question 3:</h4>
													...
													<ul>
														...
														<li>
															After plotting armature current as a function of machine speed, explain why the armature current increases with speed.  Use the circuit model of the motor to justify your comments.
														</li>
 ...
 <h4>Question 4:</h4>
													...
													<ul>
														...
														<li>
															Is the calculated motor torque nearly constant?  Explain why.
														</li>
													</ul>
...
<!-- tutor ends here-->
		...
		<script src="js/plugins/tutor/tutor_exp7.js"></script>
		<!--tutor js end-->
				...
				<script type="text/javascript" src="experiment7/js/plugins/numeric-1.2.6.min.js"></script>
				<script>
				...
				<script>
					...
					$('#button_2').click(function() {
						...
						for ( i = 1; i <= 13; i++) {
							mySpeed[i] = parseFloat(document.getElementById("e" + i).value);
							myVoltage[i] = parseFloat(document.getElementById("b" + i).value);
							//alert(myVoltage[i]);
						}
						...
						chart.addSeries({
							...
							name : 'Current',
							data : [[mySpeed[1], myVoltage[1]], [mySpeed[2], myVoltage[2]], [mySpeed[3], myVoltage[3]], [mySpeed[4], myVoltage[4]], [mySpeed[5], myVoltage[5]], [mySpeed[6], myVoltage[6]], [mySpeed[7], myVoltage[7]], [mySpeed[8], myVoltage[8]], [mySpeed[9], myVoltage[9]], [mySpeed[10], myVoltage[10]], [mySpeed[11], myVoltage[11]], [mySpeed[12], myVoltage[12]], [mySpeed[13], myVoltage[13]]]
							//data: [[a, b],[c,d], [e,f]]
						});
				...
				<script>
					...
					$('#button_1').click(function() {
						...
						for (var i = 1; i <= 13; i++) {
							...
							myCurrent[i] = parseFloat(document.getElementById("v" + i).value);
							myVoltage_b[i] = parseFloat(document.getElementById("e" + i).value);
							myVoltage_e[i] = parseFloat(document.getElementById("h" + i).value);
							//alert(myVoltage[i]);
						}
						...
						chart.addSeries({
							...
							name : 'Motor',
							data : [[myCurrent[1], myVoltage_b[1]], [myCurrent[2], myVoltage_b[2]], [myCurrent[3], myVoltage_b[3]], [myCurrent[4], myVoltage_b[4]], [myCurrent[5], myVoltage_b[5]], [myCurrent[6], myVoltage_b[6]], [myCurrent[7], myVoltage_b[7]], [myCurrent[8], myVoltage_b[8]], [myCurrent[9], myVoltage_b[9]], [myCurrent[10], myVoltage_b[10]], [myCurrent[11], myVoltage_b[11]], [myCurrent[12], myVoltage_b[12]], [myCurrent[13], myVoltage_b[13]]]
							//data: [[a, b],[c,d], [e,f]]
						});
						chart.addSeries({
							animation : {
							...
							name : 'Calculated',
							data : [[myCurrent[1], myVoltage_e[1]], [myCurrent[2], myVoltage_e[2]], [myCurrent[3], myVoltage_e[3]], [myCurrent[4], myVoltage_e[4]], [myCurrent[5], myVoltage_e[5]], [myCurrent[6], myVoltage_e[6]], [myCurrent[7], myVoltage_e[7]], [myCurrent[8], myVoltage_e[8]], [myCurrent[9], myVoltage_e[9]], [myCurrent[10], myVoltage_e[10]], [myCurrent[11], myVoltage_e[11]], [myCurrent[12], myVoltage_e[12]], [myCurrent[13], myVoltage_e[13]]]//data: [[a, b],[c,d], [e,f]]
						});
						//chart.addSeries([[0,i], [0.1,14.0], [0.2,17.0], [0.3,135.6], [0.4,14.5], [0.5,21.4], [0.6,19], [0.7,20], [0.8,21], [0.9,29],[1.0,29],[1.1,29],[1.2,29]] );
					});
				...
				<script type="text/javascript" src="experiment7/js/jquery.fancybox.js"></script>
				<script type="text/javascript">
					function viewTable() {
						//myCurrent = []; //Clear the array
						//myVoltage = [];
						//mytable = [];
						var myFCurrent = new Array();
						...
						for (var i = 1; i <= 13; i++) {
							...
							str4 = document.getElementById("h" + i).value;
							myFCurrent[i - 1] = str1;
							myACurrent[i - 1] = str2;
							mySpeed[i - 1] = str3;
							myCSpeed[i - 1] = str4;
						...
						for (var i = 1; i <= 4; i++) {
							...
							str5 = document.getElementById("question" + i).value;
						...
						var str_json = JSON.stringify(experiment7_1);
						request = new XMLHttpRequest();
						if (confirm("Do you want to save your data?")) {
							request.open("POST", "JSON_Handler7_1.php", true);
