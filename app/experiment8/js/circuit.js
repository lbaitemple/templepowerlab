    		...
    		if(location===key)
    		{
    			 ...
    			 if(component===value)
    			 {
					...
					reminder=0;
    			 	...
    			 	reminder++;
    			 	if(reminder===5){
    			 		toastr.warning("<div>Sorry! You placed the component<b style='color:red'><i> incorrectly 5 times</i></b>!</div><a href='../captivate/callees/EXP8/' target='_top' class='btn btn-success'>Review slides</a> <button type='button' id='surpriseBtn' class='btn' style='margin: 0 8px 0 8px'>Close</button></div>");
    			 		reminder=0;
    			 	}else{
