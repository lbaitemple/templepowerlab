...
var calcExp1 = function(resistor_button, connection) {
    ...
    V=E_a-R_a*I_a;*/
			...
			var I_f_eq = I_f + 0.15* I_a;
			
			 //R_total=R_L+R_s;
    		//I_L=V/R_total;
    		//I_a=I_f+I_L;
			var R_total=0.2;
			var I_L=calcExp1.current2;
			I_a=I_f+I_L;
			...
			var I_L=calcExp1.current2;
			console.log("I_L: "+I_L);
			console.log("R_total: "+R_total);
			I_a=parseFloat(I_f)+parseFloat(I_L);
			console.log("I_a2: "+I_a);
			var arg = I_f_eq / 0.05;
			var arg_r = 0.05 / I_f_eq;
			var e = Math.exp(2);
