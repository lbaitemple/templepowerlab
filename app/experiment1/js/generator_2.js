...
$(function(){
    ...
    var $generator = $('#generatorCanvas_2');
    ...
    var MOTOR_OUTER = {context:genCtx, url:"experiment1/images/motor_outer.jpg", x:0, y:0, type:CANVAS_TYPE_IMAGE};
    var MOTOR_SHAFT = {context:genCtx, url:"experiment1/images/motor_shaft.png", x:137, y:143, x_rotate: 249, y_rotate: 255, type:CANVAS_TYPE_IMAGE};
    var MOTOR_FLUX = {context:genCtx, url:"experiment1/images/motor_flux.png", x:137, y:143, x_rotate: 249, y_rotate: 255, type:CANVAS_TYPE_IMAGE};
