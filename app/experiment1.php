...
<html>
	...
	<head>
		...
		<!--Tutor starts - Include with every page >
		<ink rel="stylesheet" type="text/css" href="css/plugins/tutor/sidebar.css" />
		<link rel="stylesheet" type="text/css" href="js/plugins/tutor/qtip/jquery.qtip.css" /-->
		<link href="css/plugins/tutor/styles.css" rel="stylesheet" />

		<!-- Tutor Ends- Include with every page -->
 ...
 <h4>Question 7:</h4>
					...
					<div class="container" style="position:fixed;top: 10px; right:10px">
										...
										<div class="row msg_container base_receive">
											...
											<div class="col-md-10 col-xs-10">
												<div class="messages msg_receive">
													<p>
														Hi! This is the tutor for this virtual power laboratory. Please type your question below and I will find a proper answer for you.
													</p>
				...
				<!-- /#wrapper -->
				<!-- Tutor js Starts- Include with every page >

				<script type="text/javascript" src="http://code.jquery.com/jquery.min.js"></script>
				<script type="text/javascript" src="http://code.jquery.com/ui/1.8.13/jquery-ui.min.js"></script>
				<script type="text/javascript" src="js/plugins/tutor/jquery.sidebar.js"></script>
				<script type="text/javascript" src="js/plugins/tutor/jquery.mockjax.js"></script>
				<script type="text/javascript" src="js/plugins/tutor/jquery.autocomplete.js"></script>
				<script type="text/javascript" src="js/plugins/tutor/countries.js"></script>
				<script type="text/javascript" src="js/plugins/tutor/demo.js"></script>
				<script type="text/javascript" src="js/plugins/tutor/qtip/jquery.qtip.min.js"></script>
				<script type="text/javascript" src="js/plugins/tutor/qtip/imagesloaded.pkg.min.js"></script>
				<!-- Tutor js Ends- Include with every page -->
				<script src="js/jquery-1.10.2.js"></script>
				<script src="js/plugins/tutor/countries.js"></script>
				<script src="js/plugins/tutor/tutor.js"></script>
